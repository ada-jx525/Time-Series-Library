...
def _require_huggingface_download():
    raise ImportError(
        "Missing optional Hugging Face dependencies. Install `datasets` and "
        "`huggingface_hub`, or place the dataset files under root_path."
    )
